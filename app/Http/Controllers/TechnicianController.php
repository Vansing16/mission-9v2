...
class TechnicianController extends Controller
{
     ...
     */
     ...
     public function showTechnicianTickets(Request $request)
     {
         ...
         $ticketsQuery = Ticket::where('technician_id', $technicianId);
    ...
    public function storeMessage(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $imageName = '' . date('Ymd_His') . '_' . uniqid() . '.' . $image->getClientOriginalExtension();
            $image->move(public_path('message_images'), $imageName); // Move the image to public/message_images

            // Set the imagePath to be accessible publicly
    ...
    public function updateSettings(Request $request)
    {
        ...
        if ($request->hasFile('profile_picture')) {
            ...
            if ($technician->profile_image && file_exists(public_path('technician_profile_image_folder/' . $technician->profile_image))) {
                unlink(public_path('technician_profile_image_folder/' . $technician->profile_image));
            }

            $image = $request->file('profile_picture');

            $imageName = 'technician_profile_image_folder/' . $technician->id . '_' . date('Ymd_His') . '.' . $image->getClientOriginalExtension();
            $image->move(public_path('technician_profile_image_folder'), $imageName);
