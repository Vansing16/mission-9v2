        ...
        <div class="p-4">
            <form class="user" method="POST" action="{{ route('customer.update-settings') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="mb-2 form-control" id="name" name="name" placeholder="Sothea"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="mb-2 form-control" id="email" name="email"
                        placeholder="example@example.com" value="{{ old('email', $customer->email) }}">
                    @error('email')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="password" class="mb-2 form-control" id="newPassword" name="newPassword"
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="mb-2 form-control" id="confirmNewPassword" name="newPassword_confirmation"
                        ...
                        <select id="nationality" name="nationality" class="form-control">
                            ...
                            @foreach ($nationalities as $nationality)
                                <option value="{{ $nationality }}"
                                    {{ old('nationality', $customer->nationality) == $nationality ? 'selected' : '' }}>
